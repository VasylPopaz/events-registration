...
export const ParticipantsListItem: React.FC<IParticipantListItemProps> = ({
  ...
  return (
    <li className=" flex flex-col justify-between text-text-color p-[18px] text-[20px] bg-bg-card-color  rounded-[18px] w-[100%] md:w-[358px] lg:w-[362px] lg:p-[24px] shadow-custom-inset">
      <p>{name}</p>
